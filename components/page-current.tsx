      ...
      <section className="py-20 bg-gradient-to-b from-gray-900 to-gray-800">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-gradient-to-br from-green-600/10 to-emerald-600/10 backdrop-blur-sm border border-green-500/20 rounded-2xl overflow-hidden">
            ...
            <div className="bg-gradient-to-br from-yellow-600/10 to-green-600/10 backdrop-blur-sm border border-yellow-500/20 rounded-2xl overflow-hidden">
      ...
      <section id="features" className="py-20 bg-gradient-to-b from-gray-800 to-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-gradient-to-br from-green-600/10 to-emerald-600/10 backdrop-blur-sm border border-green-500/20 rounded-2xl overflow-hidden hover:shadow-2xl transition-all hover:scale-105">
            ...
            <div className="bg-gradient-to-br from-yellow-600/10 to-green-600/10 backdrop-blur-sm border border-yellow-500/20 rounded-2xl overflow-hidden hover:shadow-2xl transition-all hover:scale-105">
