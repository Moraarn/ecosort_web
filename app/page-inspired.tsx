        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <div className="w-8 h-8 bg-gradient-to-br from-orange-500 to-emerald-600 rounded-lg flex items-center justify-center">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight">
                ...
                <span className="block text-orange-600">Environmental Wealth</span>
              </h1>
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-orange-100 to-emerald-100 rounded-3xl transform rotate-3"></div>
              <div className="relative bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
                <div className="aspect-square bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-20 h-20 bg-gradient-to-br from-orange-500 to-emerald-600 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <section id="impact" className="py-20 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="text-4xl font-bold text-orange-600 mb-2">250T</div>
              <div className="text-gray-600">Waste Recycled</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-orange-600 mb-2">KES 2.5M</div>
              <div className="text-gray-600">Community Earnings</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-orange-600 mb-2">3.2T</div>
