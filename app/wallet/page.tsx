...
export default function Wallet() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-emerald-100 flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-emerald-100 py-12">
          ...
          {userData && (
            <div className="grid md:grid-cols-4 gap-6 mb-8">
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <div className="text-3xl font-bold text-orange-600">{userData.totalPoints.toLocaleString()}</div>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <div className="text-3xl font-bold text-orange-600">{getProgressToNextRank().toFixed(0)}%</div>
                    ...
                    {rewardHistory.map((reward) => (
                      <div key={reward.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        ...
                        <div className="text-right">
                          <div className="text-lg font-bold text-orange-600">+{reward.points}</div>
                ...
                <div className="space-y-3">
                  {leaderboard.slice(0, 5).map((user) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        <div className="font-bold text-orange-600">{user.totalPoints.toLocaleString()}</div>
                        <div className="text-xs text-gray-500">points</div>
                      </div>
                    </div>
                  ))}
                ...
                {userData && userData.rank > 5 && (
                  <div className="mt-4 pt-4 border-t border-gray-200">
                    <div className="flex items-center justify-between p-3 rounded-lg bg-orange-50 border border-orange-200">
                      ...
                      <div className="text-right">
                        <div className="font-bold text-orange-600">{userData.totalPoints.toLocaleString()}</div>
                        <div className="text-xs text-gray-500">points</div>
                      </div>
                    </div>
                  </div>
