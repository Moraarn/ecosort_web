...
export default function Home() {
  return (
    <div className="min-h-screen">
      ...
      <section id="features" className="py-20 bg-gradient-to-b from-gray-800 to-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-gradient-to-br from-orange-600/10 to-emerald-600/10 backdrop-blur-sm border border-orange-500/20 rounded-2xl p-8 hover:shadow-2xl transition-all hover:scale-105">
            ...
            <div className="bg-gradient-to-br from-yellow-600/10 to-orange-600/10 backdrop-blur-sm border border-yellow-500/20 rounded-2xl p-8 hover:shadow-2xl transition-all hover:scale-105">
      ...
      {/* How It Works - African Context */}
      <section id="how-it-works" className="py-20 bg-gradient-to-b from-gray-900 to-gray-800">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">How EcoSort Works in Your Community</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Simple steps designed for everyday Kenyans, from mama mboga to young professionals
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="text-center">
              <div className="relative mb-8">
                <div className="w-20 h-20 bg-gradient-to-br from-orange-500 to-emerald-500 rounded-full flex items-center justify-center mx-auto text-white text-2xl font-bold shadow-2xl">
                  1
                </div>
                <div className="hidden lg:block absolute top-10 left-full w-full h-0.5 bg-gradient-to-r from-orange-500/30 to-transparent -translate-x-8"></div>
              </div>
              ...
              <h3 className="text-xl font-bold text-white mb-2">Piga Picha</h3>
              <p className="text-gray-300">
                Take a photo of your waste - plastic bottles, food scraps, or any item you want to dispose
              </p>
            </div>

            <div className="text-center">
              <div className="relative mb-8">
                <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full flex items-center justify-center mx-auto text-white text-2xl font-bold shadow-2xl">
                  2
                </div>
                <div className="hidden lg:block absolute top-10 left-full w-full h-0.5 bg-gradient-to-r from-blue-500/30 to-transparent -translate-x-8"></div>
              </div>
              ...
              <p className="text-gray-300">
                Our smart AI instantly identifies the waste type and tells you exactly how to sort it
              </p>
            </div>

            <div className="text-center">
              <div className="relative mb-8">
                <div className="w-20 h-20 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-full flex items-center justify-center mx-auto text-white text-2xl font-bold shadow-2xl">
                  3
                </div>
                <div className="hidden lg:block absolute top-10 left-full w-full h-0.5 bg-gradient-to-r from-yellow-500/30 to-transparent -translate-x-8"></div>
              </div>
              ...
              <h3 className="text-xl font-bold text-white mb-2">Tupa Taka</h3>
              <p className="text-gray-300">
                Dispose at the correct bin location - our app guides you to the nearest collection point
              </p>
            </div>

            <div className="text-center">
              <div className="relative mb-8">
                <div className="w-20 h-20 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center mx-auto text-white text-2xl font-bold shadow-2xl">
                  4
                </div>
              </div>
              ...
              <h3 className="text-xl font-bold text-white mb-2">Pata Reward</h3>
              <p className="text-gray-300">
                Scan the QR code and earn instant points redeemable for mobile money and local services
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Community Impact */}
      <section id="impact" className="py-20 bg-gradient-to-b from-gray-800 to-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Real Impact in African Communities</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Together, we're creating cleaner, healthier, and more prosperous neighborhoods
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="text-center bg-gradient-to-br from-orange-600/10 to-emerald-600/10 backdrop-blur-sm border border-orange-500/20 rounded-2xl p-6">
              <div className="text-4xl font-bold text-orange-400 mb-2">3.2T</div>
              <div className="text-white font-medium">CO₂ Reduced Monthly</div>
              <div className="text-gray-400 text-sm mt-2">Equivalent to taking 700 cars off the road</div>
            </div>
            <div className="text-center bg-gradient-to-br from-blue-600/10 to-cyan-600/10 backdrop-blur-sm border border-blue-500/20 rounded-2xl p-6">
              <div className="text-4xl font-bold text-blue-400 mb-2">25+</div>
              <div className="text-white font-medium">Kenyan Counties</div>
              <div className="text-gray-400 text-sm mt-2">From Nairobi to Mombasa, Kisumu to Eldoret</div>
            </div>
            <div className="text-center bg-gradient-to-br from-yellow-600/10 to-orange-600/10 backdrop-blur-sm border border-yellow-500/20 rounded-2xl p-6">
              <div className="text-4xl font-bold text-yellow-400 mb-2">50K+</div>
              <div className="text-white font-medium">Active Users</div>
              <div className="text-gray-400 text-sm mt-2">Growing daily across communities</div>
            </div>
            <div className="text-center bg-gradient-to-br from-purple-600/10 to-pink-600/10 backdrop-blur-sm border border-purple-500/20 rounded-2xl p-6">
              <div className="text-4xl font-bold text-purple-400 mb-2">KES 5M+</div>
              <div className="text-white font-medium">Community Earnings</div>
              <div className="text-gray-400 text-sm mt-2">Direct economic impact to families</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-900 to-gray-800">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-gradient-to-br from-orange-600/10 to-emerald-600/10 backdrop-blur-sm border border-orange-500/20 rounded-2xl p-6">
            ...
            <div className="bg-gradient-to-br from-blue-600/10 to-cyan-600/10 backdrop-blur-sm border border-blue-500/20 rounded-2xl p-6">
              <div className="flex items-center space-x-4 mb-4">
            ...
            <div className="bg-gradient-to-br from-yellow-600/10 to-orange-600/10 backdrop-blur-sm border border-yellow-500/20 rounded-2xl p-6">
              <div className="flex items-center space-x-4 mb-4">
