        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 text-white">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white leading-tight">
              Transform Waste into <span className="text-orange-400">Environmental Wealth</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/auth/login">
                <button className="bg-orange-500 text-white px-8 py-4 rounded-full hover:bg-orange-600 transition-colors font-medium">
                  Start Free Trial
                </button>
              </Link>
              <button className="border border-orange-400 text-orange-400 px-8 py-4 rounded-full hover:bg-orange-400 hover:text-white transition-colors font-medium">
                Watch Demo
              </button>
            </div>
