            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="mb-8">
                <div
                  className={`border-2 border-dashed rounded-xl p-8 text-center transition-colors ${
                    preview ? "border-orange-500 bg-orange-50" : "border-gray-300 hover:border-gray-400"
                  }`}
                >
                  {preview ? (
              ...
              <div className="flex justify-center space-x-4">
                <button
                  ...
                  className="px-8 py-3 bg-orange-600 hover:bg-orange-700 text-white rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isClassifying ? (
