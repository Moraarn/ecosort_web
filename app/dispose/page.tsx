            ...
            <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium text-orange-600">+{pointsMap[wasteType] || 10}</p>
                </div>
              </div>
            </div>
          )}
                  ...
                  {!isScanning ? (
                    ...
                    <div className="space-y-4">
                      <div className="relative">
                        ...
                        />
                        <div className="absolute inset-0 border-2 border-orange-500 rounded-lg pointer-events-none"></div>
                      </div>
              ...
              {scanResult.success ? (
                <div className="text-center">
                  ...
                  <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-6">
                    ...
                    <div className="text-orange-700">Added to your account</div>
                  </div>
