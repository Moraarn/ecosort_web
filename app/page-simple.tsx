    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-emerald-100">
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center space-y-6">
          <div className="bg-orange-100 text-orange-800 border-orange-200 rounded-full px-4 py-2 inline-block">
      ...
      <section className="bg-orange-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link href="/auth/signup">
            <button className="bg-white text-orange-600 hover:bg-gray-100 px-8 py-3 rounded-lg text-lg font-medium">
